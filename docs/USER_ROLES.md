...
- SPV visibility is restricted to Works on projects they are assigned to via `ProjectAssignment`; all other roles' project scoping is an open question — see [OPEN_QUESTIONS.md](OPEN_QUESTIONS.md).
